...
$tokenMetadata->validateAppId('727339321118271'); // Replace {app-id} with your app id
...
$userArray['first_name'] = $user->getFirstName();
$userArray['last_name'] = $user->getLastName();
$userArray['email'] = $user->getEmail();

var_dump($userArray);

$_SESSION['fbUser'] = $userArray;
