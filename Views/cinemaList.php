                ...
                <?php $activeTab = array_shift($firstShowRooms);?>
                  ...
                  <div class="tab-pane fade active show" id="<?php echo str_replace(' ','', $activeTab->getName());?>"role="tabpanel" aria-labelledby="<?php echo str_replace(' ','', $activeTab->getName());?>-tab">
                    <div class="row">
                      ...
                      <div class="col-md-1 py-1"> <button class="btn btn-dark" type="submit" name="ShowRoomRemove" onclick="this.form.action = '<?php echo FRONT_ROOT?>ShowRoom/RemoveShowRoom'" value="<?php echo $activeTab->getId()?>">Delete</button></div>
                    </div>
                  </div>
                    <?php foreach ($cinema->getShowRoomsList() as $showRoom):?>
                      <div class="tab-pane fade" id="<?php echo str_replace(' ','', $showRoom->getName());?>" role="tabpanel" aria-labelledby="<?php echo str_replace(' ','', $showRoom->getName());?>-tab">
                        <div class="row"> 
                          ...
                          <div class="col-md-1 py-1"> <button class="btn btn-dark" type="submit" name="ShowRoomRemove" onclick="this.form.action = '<?php echo FRONT_ROOT?>ShowRoom/RemoveShowRoom'" value=" <?php echo $showRoom->getId()?>">Delete</button></div>
                        </div>
                      </div>
                    <?php endforeach ?>
                  </div>
